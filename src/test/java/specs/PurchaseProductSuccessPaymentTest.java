...
public class PurchaseProductSuccessPaymentTest extends BaseTest {
    ...
    private String CARD_NUMBER = "4811111111111114";
    ...
    public void testMakeSuccessfulPayment() throws AWTException, InterruptedException {
        purchaseProductActions.selectCreditCardPaymentMethod();
        purchaseProductActions.enterCardNumber(CARD_NUMBER);
    ...
    public void testToVerifySuccessScreen() {
        purchaseProductActions.verifySuccessScreen();
        softAssert.assertAll();
    }
